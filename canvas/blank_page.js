...
const appendText = (num) => {
  let app = document.querySelector('article');
  dbg(app)

  app.appendChild(node)
  // let x = document.getElementsByName("article");
  // x.appendText(texts[1])
}
const drawText = () => {
  if (GLOBAL_WHITEBOARD_MARK_COUNT == 1 && draw_1) {
    draw_1 = false;
    appendText(1)
  }
  if (GLOBAL_WHITEBOARD_MARK_COUNT == 2 && draw_2) {
    draw_2 = false;
    appendText(2)
  }
}
